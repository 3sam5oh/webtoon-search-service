...
//            // Given
//            String query = "힘쎈여자";
//            LoadWebtoonResponse.WebtoonDTO sampleWebtoon = LoadWebtoonResponse.WebtoonDTO.builder()
//                    .id("kakao_3727")
//                    .title("[드라마 외전] 힘쎈여자 황금주")
//                    .provider("KAKAO")
//                    .build();
//            LoadWebtoonResponse mockResult = new LoadWebtoonResponse(Collections.singletonList(sampleWebtoon));
//
...
//            LoadWebtoonResponse mockResult = new LoadWebtoonResponse(Collections.emptyList());
//
//            when(searchWebtoonUseCase.searchWebtoons(any(SearchWebtoonRequest.class))).thenReturn(mockResult);
//
//            // When
