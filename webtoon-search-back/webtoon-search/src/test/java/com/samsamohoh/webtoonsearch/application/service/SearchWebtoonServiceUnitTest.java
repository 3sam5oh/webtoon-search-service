...
//
//import com.samsamohoh.webtoonsearch.application.port.in.webtoon.dto.LoadWebtoonRequest;
//import com.samsamohoh.webtoonsearch.application.port.in.webtoon.dto.SearchWebtoonRequest;
//import com.samsamohoh.webtoonsearch.application.port.in.webtoon.dto.LoadWebtoonResponse;
...
//    private LoadWebtoonResponse.WebtoonDTO sampleWebtoonDTO;
//
//    @BeforeEach
//    void setUp() {
//        searchWebtoonService = new SearchWebtoonService(loadWebtoonPort, customMetrics);
//
//        sampleWebtoonDTO = LoadWebtoonResponse.WebtoonDTO.builder()
//                .id("kakao_3727")
...
//            LoadWebtoonResponse expectedResult = new LoadWebtoonResponse(Arrays.asList(sampleWebtoonDTO));
//
//            logger.info("검색어: {}", query);
//            logger.info("예상 결과: {}", expectedResult);
//
//            when(loadWebtoonPort.loadWebtoons(any(LoadWebtoonRequest.class))).thenReturn(expectedResult);
//
//            // When
//            logger.info("searchWebtoons 메서드 호출");
//            LoadWebtoonResponse result = searchWebtoonService.searchWebtoons(command);
//
//            // Then
//            logger.info("결과 검증");
...
//
//            verify(loadWebtoonPort).loadWebtoons(any(LoadWebtoonRequest.class));
